...
EAR_THRESHOLD = 0.24
CONSECUTIVE_FRAMES = 3  # Number of frames the eye must be below the threshold to count as a blink
...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, f'EAR: {self.avg_EAR:.2f}', (30, 250), self.font, 0.8, (0, 0, 255), 2)
        cv2.putText(img_rd, f'blink: {self.blink_count:.2f}', (30, 350), self.font, 0.8, (0, 0, 255), 2)
                    ...
                    # 6.2.2 / Face cnt increase: 0->1, 0->2, ..., 1->2, ...
                        ...
                        for k in range(len(faces)):
                            ...
                            if min(self.current_frame_face_X_e_distance_list) < 0.4:
                                ...
                                # Detect blinking for left and right eyes
                                ...
                                #   cv2.putText(img_rd, f'EAR: {avg_EAR:.2f}', (30, 250), self.font, 0.8, (0, 0, 255), 2)
